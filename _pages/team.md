...
<div style="flex: 0 0 300px; min-width: 250px; margin-left: 40px;">
  <img src="{{ site.url }}{{ site.baseurl }}/images/3_others/team_pic/Jiyizhe3.jpg" 
...
<div class="col-sm-6 clearfix" style="margin-bottom: 25px;">
  ...
  {% if member.education %}
  <ul style="overflow: hidden; margin-top: 8px; margin-bottom: 0; padding-left: 0; list-style-position: inside;">
